                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex flex-wrap gap-1 mb-3">
                        {channel.externalUrl && (
                          <span className="px-2 py-1 bg-cyan-500/20 text-cyan-400 text-xs font-semibold rounded flex items-center gap-1">
                      ...
                      <div className="text-xs text-gray-500 mb-4 space-y-0.5">
                        <div>Packages: {channel.requiredPackages.length > 0 ? channel.requiredPackages.join(', ') : 'Free (All)'}</div>
                        <div>Sort Order: {channel.order}</div>
                        {channel.externalUrl && (
                          <div className="flex items-center gap-1 text-cyan-400/80 truncate mt-1">
